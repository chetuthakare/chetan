...
class FontSampleData extends \Magento\Backend\App\Action
{

    const CSV_FILE ="personalization_fonts.csv";

    const TABLE_NAME ="personalization_font";

    public function __construct(
        Context $context,
        \SetuBridge\Personalization\Helper\Data $helperData,
        \SetuBridge\PersonalizationTemplate\Controller\Adminhtml\Font\ImportSave $importSave,
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->getRequest()->setPostValue('file_directory',"pub/media/Personalization/import/fonts");
            ...
            $this->_redirect('personalization/font/importsave');
