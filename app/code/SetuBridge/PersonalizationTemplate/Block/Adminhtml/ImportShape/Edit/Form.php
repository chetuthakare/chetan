...
namespace SetuBridge\PersonalizationTemplate\Block\Adminhtml\ImportShape\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('personalization_template_importshape_');
        ...
        $fieldset->addType('csvfile', '\SetuBridge\PersonalizationTemplate\Block\Adminhtml\ImportShape\Csvfile');
