...
?>
<?php
namespace SetuBridge\Clipart\Block\Adminhtml\ImportClipart\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('personalization_template_importclipart_');
        ...
        $fieldset->addType('csvfile', '\SetuBridge\Clipart\Block\Adminhtml\ImportClipart\Csvfile');
