...
class PatternsButton extends Field
{
    ...
    {
        return $this->getUrl('personalization/index/patternsampledata');
    }
    ...
    {
        $mediaDirectory = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA);            
        $dir = $mediaDirectory->getAbsolutePath('Personalization/import/patterns');
        return is_dir($dir);
    }
