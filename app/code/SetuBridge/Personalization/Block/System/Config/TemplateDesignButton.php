...
class TemplateDesignButton extends Field
{
    ...
    {
        return $this->getUrl('personalization/index/templatedesignsampledata');
    }
    ...
    {
        $mediaDirectory = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA);            
        $dir = $mediaDirectory->getAbsolutePath('Personalization/import/templatedesigns');
        return is_dir($dir);
    }
