...
namespace SetuBridge\TemplateDesigns\Block\Adminhtml\ImportTemplateDesigns\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('personalization_template_importtemplatedesigns_');
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('Import'),
                'id' => 'csv',
                'title' => __('Import TemplateDesigns'),
        ...
        $fieldset->addType('csvfile', '\SetuBridge\TemplateDesigns\Block\Adminhtml\ImportTemplateDesigns\Csvfile');
